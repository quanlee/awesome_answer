class Question < ActiveRecord::Base
  ...
  #belongs_to :category  # still needs to be implemented
  ...
  # computer science, law of demeter, external (ie question.show.html.erb) objects should not need to know how this (question) object implements the methods ie uses internal dependant (user) objects
  def user_full_name
    user ? user.full_name : ""
  end
